...
export default function Page() {
  ...
  const rightSectionFor = (value: string) =>
    value ? <CheckGlyph /> : <span className="text-2xl text-zinc-500">*</span>;
  return (
      ...
      <div className="relative z-10 flex min-h-screen items-start justify-center px-4 py-12 sm:items-center sm:px-8">
        <Container size={623} className="w-full">
          <div className=" border border-black/10 bg-white/80 px-6  py-20 shadow-[0_30px_90px_rgba(0,0,0,0.08)] backdrop-blur sm:px-10">
              ...
              >
                <Stack gap={22}>
                  ...
                  <TextInput
                    ...
                    placeholder="Name"
                    variant="unstyled"
                    rightSection={rightSectionFor(form.name)}
                    rightSectionPointerEvents="none"
                  ...
                  <TextInput
                    ...
                    placeholder="Surname"
                    variant="unstyled"
                    rightSection={rightSectionFor(form.surname)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                  ...
                  <TextInput
                    ...
                    variant="unstyled"
                    rightSection={rightSectionFor(form.nickname)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                  ...
                  <TextInput
                    ...
                    variant="unstyled"
                    rightSection={rightSectionFor(form.dob)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                    autoComplete="bday"
                  ...
                  <TextInput
                    ...
                    type="password"
                    variant="unstyled"
                    rightSection={rightSectionFor(form.password)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                  ...
                  <TextInput
                    ...
                    type="password"
                    variant="unstyled"
                    rightSection={rightSectionFor(form.confirmPassword)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                    autoComplete="new-password"
                  ...
                  <TextInput
                    ...
                    variant="unstyled"
                    rightSection={rightSectionFor(form.referral)}
                    rightSectionPointerEvents="none"
                    rightSectionWidth={18}
                    classNames={fieldClassNames}
                  />
            ...
            >
              <Text className={`${workSans.className} text-center !underline text-[#000]`} size="14px">
